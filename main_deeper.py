...
from rbpn_deeper import Net as RBPN 
from rbpn_deeper import FeatureExtractor, Discriminator
...
optim_discriminator = optim.Adam(discriminator.parameters(), lr=opt.lr*10.0)
